...
from tc_entitylinking import EntityLinkingRanking
...
parser.add_argument("use_entity_linking", type=str, help="Use entity linking for enhanced queries and paragraphs")
