...
if algorithm == 'BM25':
    ranking = Ranking(query_cbor, paragraphs_cbor)
    ...
    if cache_flag == 'cache':
        ...
        query_structure = _pickle.load(open(os.path.join(os.curdir, "_cache/query_structure_cache"), "rb"))
        document_structure = _pickle.load(open(os.path.join(os.curdir, "_cache/paragraph_structure"), "rb"))
        TDELTAIDF.average_doc_length = _pickle.load(open(os.path.join(os.curdir, "_cache/average_length_of_documents"), "rb"))
        TDELTAIDF.no_of_docs_dict = _pickle.load(open(os.path.join(os.curdir, "_cache/no_of_docs_with_term"), "rb"))
    ...
    if cache_flag == 'cache':
        ...
        DIRICHLET.number_of_words_in_the_collection_s = \
            _pickle.load(open(os.path.join(os.curdir, "_cache/no_of_words_in_the_collection"), "rb"))
        DIRICHLET.all_words_freq_dict = _pickle.load(open(os.path.join(os.curdir, "_cache/all_terms_freq_dict"), "rb"))
